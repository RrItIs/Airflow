...
class OpenLineageMixin:
    ...
    allowing us to check for it's existence rather than existence of particular methods on BaseOperator.
    """
    ...
    def get_openlineage_facets_on_fail(self, task_instance: TaskInstance) -> OperatorLineage:
